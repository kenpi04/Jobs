...
parallaxSlider.prototype={
	...
	init:function($){
		...
		//var $controls =  $('<img class="navbutton prev" src="'+controlpaths[1]+'" data-dir="forth" style="position:absolute; z-index:5; cursor:pointer; ' + (orientation=='v'? 'bottom:8px; left:46%' : 'top:46%; right:8px;') + '" />'
		//	+ '<img class="navbutton next" src="'+controlpaths[0]+'" data-dir="back" style="position:absolute;z-index:5; cursor:pointer; ' + (orientation=='v'? 'top:8px; left:45%' : 'top:45%; left:8px;') + '" />'
		//)
		var $controls = $('<div class="navbutton next" data-dir="forth" style="position:absolute; z-index:5; cursor:pointer; ' + (orientation == 'v' ? 'bottom:8px; left:46%' : 'top:46%; right:8px;') + '" ></div>'
        + '<div class="navbutton prev"  data-dir="back" style="position:absolute;z-index:5; cursor:pointer; ' + (orientation == 'v' ? 'top:8px; left:45%' : 'top:45%; left:8px;') + '" ></div>'
        )
		.css({opacity:0})
		.click(function(){
